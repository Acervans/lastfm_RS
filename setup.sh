...
# App modules
pip3 install autopep8 django django-admin dj_database_url psycopg2-binary bs4 nltk spacy pylast lyricsgenius whitenoise djLint tensorflow_recommenders
# Additional modules
